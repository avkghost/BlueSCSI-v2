...
#define FIRMWARE_PACKAGE_PREFIX "BlueSCSI_v"
#define FIRMWARE_UPLOAD_NAME "BlueSCSI_update.zip"
...
#define DRIVEINFO_AMIGAWIFI {"Dayna",    "SCSI/Link",       "2.0f", ""}
